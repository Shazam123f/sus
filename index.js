const developer_Name = ",`!  Mr ٠ Monzĕr#9010"; // My Account Name
const developer_Id = "399866875418247168"; // My Account ID.
const YouTube_Channel = "Hidrex" // .
...
const admin = "1006955739971072101"; // ايدي الي يتحكم بالبوت
...
client.on('ready', () => {
  ...
  client.user.setActivity('Nc Services ⚡', {
    type: "WATCHING"
  });
  ...
  if (message.content === prefix + "bot") {
    ...
    if (admin.includes(message.author.id)) {
      ...
      const embed = new MessageEmbed()
        ...
        .addField('`Developer`', "Mr.Monzer", true)
...
app.listen(() => console.log(`v2 Broadcast Bot Mr.Monzer
